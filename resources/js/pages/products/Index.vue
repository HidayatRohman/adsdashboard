          ...
          <div>
            ...
            <div class="space-y-2">
              <div v-for="(v, idx) in form.variations" :key="idx" class="flex gap-2 items-center">
                ...
                <button type="button" class="btn" @click.prevent="form.variations.splice(idx,1)">Hapus</button>
              </div>
              <button type="button" class="btn" @click.prevent="form.variations.push({ name: '', price: null })">Tambah Variasi</button>
            </div>
          </div>
      ...
      <div class="grid auto-rows-min gap-4 md:grid-cols-1">
        <div class="relative overflow-hidden rounded-xl border border-sidebar-border/70 dark:border-sidebar-border p-4">
          <div class="flex items-center justify-between">
            ...
            <button class="btn btn-primary" @click.prevent="openCreate">Tambah Produk</button>
          </div>
            ...
            <tbody>
              <tr v-for="p in products.data" :key="p.id" class="border-t">
                ...
                <td class="p-2 text-center">
                  <button @click="edit(p)" class="mr-2 text-blue-600">Edit</button>
                  <button @click="destroy(p.id)" class="text-red-600">Hapus</button>
                </td>
              </tr>
            </tbody>
          </table>
